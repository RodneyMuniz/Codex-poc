...
- original_request: Run 1 bounded supervised architect-stop rehearsal for AIO-033 to check multi-run stability, isolated residue containment, and persisted-state inspection.
