...
1. `AIO-040` - define narrow operator-facing bundle decision surface and fail-closed rules
2. `AIO-041` - implement narrow operator CLI wrapper over the sanctioned bundle decision path
3. `AIO-042` - rehearse the operator-facing decision surface under supervision and record evidence
